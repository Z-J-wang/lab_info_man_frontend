  ...
  children: [
    {
      ...
      name: 'ownspace_index',
      title: '个人中心',
      component: () => import('../components/OwnSpace.vue')
    },
...
export const appRouters = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        title: '我创建的',
        icon: 'ios-flame',
        component: () => import('../components/ticket/Myself.vue'),
        meta: { isAdmin: false, hidden: false }
      },
      {
        path: 'todo',
        ...
        title: '我的待办',
        icon: 'android-attach',
        component: () => import('../components/ticket/Todo.vue'),
        meta: { isAdmin: false, hidden: false }
      },
      {
        path: 'audit',
        ...
        component: () => import('../components/ticket/Audit.vue'),
        meta: { isAdmin: false, hidden: false }
      },
      {
        path: 'all',
        ...
        title: '所有工单',
        icon: 'android-list',
        component: () => import('../components/ticket/All.vue'),
    ...
    children: [
      {
        ...
        title: '流程管理',
        icon: 'network',
        component: () => import('../components/manage/Workflow.vue'),
        meta: { isAdmin: true, hidden: false }
      },
      {
        path: 'log',
        ...
        title: '任务日志',
        icon: 'ios-book',
        component: () => import('../components/manage/Log.vue'),
        meta: { isAdmin: true, hidden: false }
      }
    ],
    meta: { isAdmin: true }
